...
The class under contract here is `Detain\MyAdminFloatingIps\Plugin`.
...
- This package declares `$module = 'floating_ips'`. Changing it detaches the plugin from the events core dispatches to it, so the generated pin asserts it.
